...
{
    const char* pszTimestamp = "Bloopity bloop bloopity bloop bloop";
    const CScript genesisOutputScript = CScript() << ParseHex("0497315aed415de8fc2b92d25c4d872116ec59e577a566836d684d53337ccc26c03170264c123390a310938535908664f09e2e7e8e86fe6c6871c79e506e35bb70") << OP_CHECKSIG;
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1717531098, 647629, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000006f07ae0daf97ee651fcc37b46ae07ca8d7bb3be783e662bd1f701003b33"));
        ...
        consensus.nMNCollateralMinConf = 3;
        ...
        consensus.height_last_invalid_UTXO = 200;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_POS].nActivationHeight           = 100;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight         = 100;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight     = 100;
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight          = 100;
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 100;
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight          = 100;
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 100;
        consensus.vUpgrades[Consensus::UPGRADE_V5_3].nActivationHeight          = 100;
        consensus.vUpgrades[Consensus::UPGRADE_V5_5].nActivationHeight          = 100;
        consensus.vUpgrades[Consensus::UPGRADE_V5_6].nActivationHeight          = 100;  // Estimate Feb 29th 12:00 UTC
